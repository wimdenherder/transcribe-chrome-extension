...
// document.addEventListener('DOMContentLoaded', function() {
  ...
  function draw() {
      ...
      canvasCtx.clearRect(0, 0, canvas.width, canvas.height);
        ...
        for (let i = 0; i < bufferLength; i++) {
            if (dataArray[i] > thresholdNote) { // drempelwaarde
  ...
  function drawNoteOnKeyboard(note, canvasCtx) {
      ...
      let xPosition = correctionKeyboadBase + (note - 24) * (canvas.width / (88 - correctionKeyboardImageStretch)); // voorbeeld voor een 88 toetsen piano
    ...
    //   console.log({note})
      ...
      noteColors = ['red','orange','yellow','green','blue','purple','pink','brown','black','lightgreen','grey','cyan']
